...
const translations = {
  uz: {
    ...
    books: {
      ...
      freeBooks: 'Bepul',
      exploreFree: 'Bepul kashf etish',
      exploreGutenberg: 'Gutenberg bepul kitoblari',
      exploreOpenLibrary: 'Open Library',
      exploreGoogleFree: 'Google bepul kitoblar',
      seeAllFree: 'Barcha bepul',
    },
    profile: {
      title: 'Profil',
      settings: 'Sozlamalar',
    ...
    reader: {
      ...
      translatePlaceholder: 'Tarjima qilish uchun matnni kiriting.',
      translated: 'Tarjima',
      copy: 'Nusxalash',
      pageNumber: 'Sahifa',
      progressHint: 'Mutolaa jarayoni',
      minLeft: 'daq'
    },
  ...
  ru: {
    ...
    books: {
      ...
      freeBooks: 'Бесплатно',
      exploreFree: 'Бесплатные книги',
      exploreGutenberg: 'Gutenberg',
      exploreOpenLibrary: 'Open Library',
      exploreGoogleFree: 'Google бесплатные',
      seeAllFree: 'Все бесплатные',
    },
    profile: {
      title: 'Профиль',
      settings: 'Настройки',
  ...
  en: {
    ...
    books: {
      ...
      freeBooks: 'Free',
      exploreFree: 'Explore free',
      exploreGutenberg: 'Gutenberg',
      exploreOpenLibrary: 'Open Library',
      exploreGoogleFree: 'Google free',
      seeAllFree: 'All free',
    },
    profile: {
      title: 'Profile',
