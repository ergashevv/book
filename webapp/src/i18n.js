...
const translations = {
  uz: {
    ...
    nav: { home: 'Bosh sahifa', books: 'Kitoblar', library: 'Kutubxona', news: 'Yangiliklar', profile: 'Profil', category: 'Kategoriya', cart: 'Savat', aria: 'Asosiy menyu' },
    banner: {
  ...
  ru: {
    ...
    nav: { home: 'Главная', books: 'Книги', library: 'Библиотека', news: 'Новости', profile: 'Профиль', category: 'Категория', cart: 'Корзина', aria: 'Главное меню' },
    banner: {
  ...
  en: {
    ...
    layout: { appName: 'Home' },
    nav: { home: 'Home', books: 'Books', library: 'Library', news: 'News', profile: 'Profile', category: 'Category', cart: 'Cart', aria: 'Main menu' },
    banner: {
